...
public class Pantalla extends javax.swing.JFrame {
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        this.a = Float.parseFloat(this.jTextField1.getText());
        this.operador = "*";
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        this.b = Float.parseFloat(this.jTextField1.getText());
        
        switch (this.operador) {
            
            case "+": 
                this.jTextField1.setText(Float.toString(this.a+this.b));
            ...
            case "mod":
                ...
                break;
            case "raiz":
                this.jTextField1.setText(Double.toString(Math.sqrt(this.b)));
                
                break;
            case "sen":
                this.jTextField1.setText(Double.toString(Math.sin(this.b)));
                
                break;
                
            case "cos": 
                this.jTextField1.setText(Double.toString(Math.cos(this.b)));
                
                break;
                
            case "tan": 
                this.jTextField1.setText(Double.toString(Math.tan(this.b)));
                
                break;
                
            case "exp": 
                this.jTextField1.setText(Double.toString(Math.pow(this.a, this.b)));
